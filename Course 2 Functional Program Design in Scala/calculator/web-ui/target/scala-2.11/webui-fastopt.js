...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$applyColor__I__T = (function(numChar) {
  return ((numChar >= 15) ? "green" : ((numChar >= 0) ? "orange" : "red"))
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$applyColor__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
